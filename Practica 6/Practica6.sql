...
ADD CONSTRAINT FK_SucursalMunicipio
Foreign key (municipio_id) references municipios(id)

ALTER TABLE empleado
ADD CONSTRAINT FK_EmpleadoMunicipio
Foreign key (municipio_id) references municipios(id)

ALTER TABLE colonia
ADD CONSTRAINT FK_ColoniaMunicipio
Foreign key (municipio_id) references municipios(id)

ALTER TABLE sucursal
ADD CONSTRAINT FK_SucursalEstado
...
ALTER TABLE calle
ADD CONSTRAINT FK_MunicipioCalle
Foreign key (municipio_id) references municipios(id)
...
insert into calle values
	(1,'Chopo',998),
	(2,'2da Avenida',998),
	(3,'Paseo de los Conquistadores', 998)

select * from municipios where id=991

update calle
set municipio_id=991
where nombeCalle='Paseo de los Conquistadores'

insert into colonia values
	(1,66448,'Arboledas de Santo Domingo',998)

	update colonia
set municipio_id=991
where codigoPostal=66448
	update colonia
set municipio_id=998
where codigoPostal=66448
...
select * from productos
	...
	update productos
set precio= 265.95
where nombre='18 Tecate'

delete from productos where producto_id>10